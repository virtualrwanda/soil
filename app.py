...
from models import db, User, Prediction, IrrigationDevice, IrrigationValve, MoistureSensor, DHTSensor
...
def add_irrigation_device():
    try:
        ...
        # Create 4 valves for the device
        for i in range(1, 5):
        ...
        # Create 4 moisture sensors for the device
        for i in range(1, 5):
        ...
        # Create 4 DHT sensors for the device
        for i in range(1, 5):
